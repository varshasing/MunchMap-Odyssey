...
if __name__ == "__main__":
    ...
    latitude = [0, 37.7749, 40.7128, 34.0522, 0]  #passed by google maps api
    longitude = [0, -122.4194, -74.0060, -118.2437 ,0] #passed by google maps api
