...
def search_yelp(api_key, search_term, userPrice, latitude, longitude, radius=120): # after I sort the data, I need to return the top 3 results as a list each time I call this function
