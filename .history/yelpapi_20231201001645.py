...
def search_yelp(api_key, search_term, latitude, longitude, radius=400, prices): # after I sort the data, I need to return the top 3 results as a list each time I call this function
