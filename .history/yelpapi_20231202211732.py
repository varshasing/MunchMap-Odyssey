...
def search_yelp(api_key, search_term, userPrice, latitude, longitude, radius=100): # after I sort the data, I need to return the top 3 results as a list each time I call this function
    ...
    if response.status_code == 200:
        ...
        if(len(sorted_businesses) == 0):
            print("No results found, no sorted_buessinesses")
