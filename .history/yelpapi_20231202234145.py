...
if __name__ == "__main__":
    ...
    latitude = [0, 37.7749, 30.0000, 34.0522, 0]  #passed by google maps api
    longitude = [0, -122.4194, -95.0000, -118.2437 ,0] #passed by google maps api
    ...
    30.284031699237982, -97.72123170292599